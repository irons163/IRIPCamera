...
//- (BOOL)setupSubsession:(RTSPSubsession*)subsession useTCP:(BOOL)useTCP ch:(NSInteger) _ch;
- (BOOL)setupSubsession:(RTSPSubsession*)subsession useTCP:(BOOL)useTCP ch:(NSInteger) _ch rtspclient:(RTSPReceiver*) _client;
//- (BOOL)play;
- (BOOL)teardown;
- (BOOL) shutdownStream;
